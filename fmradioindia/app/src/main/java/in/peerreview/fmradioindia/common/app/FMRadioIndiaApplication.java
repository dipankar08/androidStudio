...
public class FMRadioIndiaApplication extends Application {
    ...
    private void test(){
        ...
        FileDownloadUtils.getInstance().download("http://cloud3.raag.me/Bengali/Jaani%20Dekha%20Hobe-(Shreya%20Ghoshal)/Jaani%20Dekha%20Hobe%20(Female)-Shreya%20Ghoshal[48]::Raag.Me::.mp3",
        ...
        DiskSearchUtils.getInstance().search(".mp3", new DiskSearchUtils.IDiskSearchCallback(){
            @Override
        ...
        // test
        TelemetryUtils.getInstance().sendTelemetry("SampleTag",new HashMap<String, String>() {{
            put("key1","value1");
        }});


        Network.getInstance().send(TEST_NETWORK_DATA,
        ...
        Player player = new Player(new Player.IPlayerCallback() {
            @Override
        ...
        player.play("Raaz","https://d.wload.vc/files/sfd215/107124/Yahan%20Pe%20Sab%20Shanti%20Hai(WapKing).mp3");
        try {
            Thread.sleep(10000);
