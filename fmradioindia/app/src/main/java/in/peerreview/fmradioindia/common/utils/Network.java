...
public class Network implements INetwork {
    ...
    @Override
    public void retrive(final String url, CacheControl cacheControl, final INetworkCallback networkCallback){
    ...
    private void retriveInternal(final String url, CacheControl cacheControl, final INetworkCallback networkCallback) {
