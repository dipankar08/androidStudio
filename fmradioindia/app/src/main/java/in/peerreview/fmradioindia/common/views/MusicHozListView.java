...
public class MusicHozListView extends LinearLayout {
  ...
  public void prepareView(
      String titleText, String ButtonText, IMusicHozListViewCallback iMusicHozListViewCallback) {
  ...
  private class ContactsAdapter extends RecyclerView.Adapter<ContactsAdapter.ViewHolder> {
    ...
    public ContactsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      ...
      View contactView =
          inflater.inflate(R.layout.customview_horizontal_list_view_item, parent, false);
