...
public class MainActivity extends AppCompatActivity {
  ...
  private void renderCameraControlPanel() {
    ...
    switch (mOrientation) {
      case PORTRAIT:
        newParams =
            new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, PANEL_WIDTH);
        ;
      ...
      case LANDSCAPE:
        newParams =
            new RelativeLayout.LayoutParams(PANEL_WIDTH, RelativeLayout.LayoutParams.MATCH_PARENT);
        ;
  ...
  private void setCameraControlEventListner() {
    ...
    mHideImageButton.setOnClickListener(
    ...
    mShowImageButton.setOnClickListener(
        new View.OnClickListener() {
          @Override
          public void onClick(View view) {
    ...
    mPanelRelativeLayout.setOnTouchListener(
  ...
  void hideCameraControlPanelAnimation() {
    ...
    ViewResizeAnimation viewResizeAnimation =
        new ViewResizeAnimation(body, dimention, startSize, endSize);
    ...
    switch (event.getAction()) {
      ...
      case MotionEvent.ACTION_MOVE:
        ...
        if (mOrientation == Orientation.PORTRAIT) {
          if (curY > orgY) {
            mPanelRelativeLayout.animate().y(curY).setDuration(0).start();
            float diffY = curY - orgY;
            ViewResizeAnimation viewResizeAnimation =
                new ViewResizeAnimation(
                    body,
                    ViewResizeAnimation.Dimention.HEIGHT,
                    body.getMeasuredHeight(),
                    (int) (parent.getMeasuredHeight() + diffY - PANEL_WIDTH));
            viewResizeAnimation.setInterpolator(new AccelerateDecelerateInterpolator());
          ...
          if (curX > orgX) {
            mPanelRelativeLayout.animate().x(curX).setDuration(0).start();
            float diffX = curX - orgX;
            ViewResizeAnimation viewResizeAnimation =
                new ViewResizeAnimation(
                    body,
                    ViewResizeAnimation.Dimention.WIDTH,
                    body.getMeasuredWidth(),
                    (int) (parent.getMeasuredWidth() + diffX - PANEL_WIDTH));
            viewResizeAnimation.setInterpolator(new AccelerateDecelerateInterpolator());
            viewResizeAnimation.setDuration(0);
            body.startAnimation(viewResizeAnimation);
          }
