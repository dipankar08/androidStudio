...
public class ZoomButtonView extends View {
  ...
  void drawIcon(Canvas canvas) {
    if (mLayout == Layout.VERTICAL) {
      canvas.drawLine(
          centerX - 15, centerY - mHeightUnit, centerX + 15, centerY - mHeightUnit, paint3);
      canvas.drawLine(
          centerX, centerY - mHeightUnit - 15, centerX, centerY - mHeightUnit + 15, paint3);
      canvas.drawLine(
          centerX - 15, centerY + mHeightUnit, centerX + 15, centerY + mHeightUnit, paint3);
    } else {
      canvas.drawLine(
          centerX - mHeightUnit - 15, centerY, centerX - mHeightUnit + 15, centerY, paint3);
      canvas.drawLine(
          centerX + mHeightUnit - 15, centerY, centerX + mHeightUnit + 15, centerY, paint3);
      canvas.drawLine(
          centerX + mHeightUnit, centerY - 15, centerX + mHeightUnit, centerY + 15, paint3);
    }
  }
