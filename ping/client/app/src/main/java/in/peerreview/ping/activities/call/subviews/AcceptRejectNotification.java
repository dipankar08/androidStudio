...
public class AcceptRejectNotification extends RelativeLayout {
  ...
  private void initView(Context context) {
    ...
    mInflater.inflate(in.peerreview.ping.R.layout.view_accept_reject_notification, this, true);
    mTextView = findViewById(in.peerreview.ping.R.id.noti_text);
    Button ac = findViewById(in.peerreview.ping.R.id.noti_accept);
    ...
    Button rj = findViewById(in.peerreview.ping.R.id.noti_reject);
