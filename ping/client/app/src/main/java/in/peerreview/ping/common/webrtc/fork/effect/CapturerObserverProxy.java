...
public class CapturerObserverProxy implements VideoCapturer.CapturerObserver {
  ...
  public void onTextureFrameCaptured(
    ...
    this.originalObserver.onTextureFrameCaptured(
  ...
  public void onFrameCaptured(VideoFrame frame) {
    ...
    // Bitmap b = BitMapUtils.NV21ToBitmap(frame.getBuffer().getData(),frame.getBuffer().getWidth(),
