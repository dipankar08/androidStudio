...
public class NotificationBuilder {
    ...
    public void showIncommingCallNotification(String msg, String call_id) {
        RemoteViews remoteViews = new RemoteViews(mContext.getPackageName(),
                R.layout.notification_accept_reject);
        ...
        Uri defaultSoundUri = Uri.parse("android.resource://"+mContext.getPackageName()+"/"+R.raw.whatsapp_whistle);//Here is FILE_NAME is the name of file that you want to play
        ...
        intent.putExtra("call_id", call_id);
        PendingIntent pIntent2 = PendingIntent.getActivity(mContext, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);
