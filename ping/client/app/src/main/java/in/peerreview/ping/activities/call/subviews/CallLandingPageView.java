...
public class CallLandingPageView extends RelativeLayout {
  ...
  private void initView(Context context) {
    ...
    View v = mInflater.inflate(in.peerreview.ping.R.layout.view_call_landing_page, this, true);

    mPeerInfo = v.findViewById(in.peerreview.ping.R.id.peer_info);

    mRecyclerView = (RecyclerView) findViewById(in.peerreview.ping.R.id.recycler_view);
    ...
    mAudio = findViewById(in.peerreview.ping.R.id.start_audio_call);
    mVideo = findViewById(in.peerreview.ping.R.id.start_video_call);
    mPoke = findViewById(in.peerreview.ping.R.id.start_poke);
