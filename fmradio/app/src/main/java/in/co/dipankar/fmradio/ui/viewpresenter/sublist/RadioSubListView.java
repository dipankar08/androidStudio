...
public class RadioSubListView extends BaseView implements RadioSubListViewPresenter.ViewContract {
  ...
  private RadioManager.DataChangeCallback dataChangeCallback =
  ...
  private void init(Context context) {
    ...
    mRadioListAdapter = new RadioListAdapter(getContext(), RadioListAdapter.ItemStyle.MAIN_SUBLIST);
  ...
  public void populateItem(String s) {
    mCategories = s;
    mTitle.setText(WordUtils.capitalize(s));
    update();
  }
