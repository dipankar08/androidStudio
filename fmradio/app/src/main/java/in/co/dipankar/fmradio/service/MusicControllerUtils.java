...
public class MusicControllerUtils {
  ...
  public void play(String id) {
    ...
    if (mRadioManager.getCurrentRadio() != null
        && mRadioManager.getCurrentRadio().getId().equals(id)) {
      if (mRadioManager.getState() == RadioManager.STATE.RESUME
          || mRadioManager.getState() == RadioManager.STATE.SUCCESS) {
        // already playing..
        return;
      }
    }
  ...
  private ServiceConnection mConnection =
      new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder iBinder) {
          MusicForegroundService.LocalBinder myLocalBinder =
              (MusicForegroundService.LocalBinder) iBinder;
              ...
              new MusicForegroundService.Callback() {
                ...
                public void onTryPlaying(String id, String msg) {
                  ...
                  FmRadioApplication.Get()
                      .getRadioManager()
                      .setCurrentRadio(id, RadioManager.STATE.TRY_PLAYING);
                }
                ...
                public void onSuccess(String id, String ms) {
                  ...
                  FmRadioApplication.Get()
                      .getRadioManager()
                      .setCurrentRadio(id, RadioManager.STATE.SUCCESS);
                }
                ...
                public void onResume(String id, String ms) {
                  ...
                  FmRadioApplication.Get()
                      .getRadioManager()
                      .setCurrentRadio(id, RadioManager.STATE.RESUME);
                }
                ...
                public void onPause(String id, String msg) {
                  ...
                  FmRadioApplication.Get()
                      .getRadioManager()
                      .setCurrentRadio(id, RadioManager.STATE.PAUSED);
                }
                ...
                public void onError(String id, String msg) {
                  ...
                  FmRadioApplication.Get()
                      .getRadioManager()
                      .setCurrentRadio(id, RadioManager.STATE.ERROR);
                }
                ...
                public void onComplete(String id, String msg) {
                  ...
                  FmRadioApplication.Get()
                      .getRadioManager()
                      .setCurrentRadio(id, RadioManager.STATE.COMPLETE);
                }
              });
        }
