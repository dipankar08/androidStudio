  ...
  public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    switch (viewType) {
      ...
      case TYPE_TITLE:
        View titleView =
            LayoutInflater.from(parent.getContext())
                .inflate(R.layout.view_item_title, parent, false);
  ...
  public void onBindViewHolder(MyViewHolder holder, int position) {
    switch (holder.getItemViewType()) {
      ...
      case TYPE_RADIO:
        ...
        Glide.with(mContext).load(item.getImage()).into(holder1.image);
        holder1.title.setText(item.getTitle());
        holder1.subtitle.setText(item.getSubtitle());
        holder1.mContainer.setOnClickListener(
      ...
      case TYPE_TITLE:
        ...
        titleHolder.title.setText(WordUtils.capitalize(titleItem.getTitle()));
        break;
    }
  }
