...
public class VideoPlayerView extends BaseView {
    ...
    private void initVideoView() {
        ...
        mVideoView.setOnErrorListener(new OnErrorListener() {
            ...
            public boolean onError(Exception e) {
                FmRadioApplication.Get().getRadioManager().setCurrentRadio(getCurId(), RadioManager.STATE.ERROR);
                return false;
            }
        });
        mVideoView.setOnPreparedListener(new OnPreparedListener() {
            ...
            public void onPrepared() {
                mVideoView.start();
                FmRadioApplication.Get().getRadioManager().setCurrentRadio(getCurId(), RadioManager.STATE.SUCCESS);
            }
        });
    ...
    private void initMenu(){
        ...
        mFeb.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                FmRadioApplication.Get().getRadioManager().toggleLove(getCurId(), new RadioManager.LoveCallback() {
                    @Override
                    public void isLoveMarked(boolean isMarked) {
                        mFeb.setImageResource(isMarked? R.drawable.ic_love_fill_white_32:R.drawable.ic_love_white_32);
                    }
                });
            }
        });
    ...
    private void play() {
        ...
        FmRadioApplication.Get().getRadioManager().setCurrentRadio(getCurId(), RadioManager.STATE.TRY_PLAYING);
