...
public class TelemetryManager {
    ...
    public static String DB_COUNT_SUCCESS = DB_ENDPOINT+"?_cmd=increment&_payload=count_success&id=";

    // Adding telemetry
    public static final String TELEMETRY_PLAYER_TRY_PLAYING = "player_click"; // indicate we are really tring.
    ...
    public TelemetryManager(){
        if(mTelemetryUtils == null) {
            mTelemetryUtils = new TelemetryUtils(
                MyApplication.Get(),
                TELEMETRY_ENDPOINT,
                true,
