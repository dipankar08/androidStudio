    ...
    private void setupCamera(int width, int height) {
        ...
        try {
            for(String cameraId : cameraManager.getCameraIdList()){
                ...
                int deviceOrientation = ((Activity)mContext).getWindowManager().getDefaultDisplay().getRotation();
                ...
                mImageReader = ImageReader.newInstance(mPreviewSize.getWidth(), mPreviewSize.getHeight(), ImageFormat.YUV_420_888 , 20);
    ...
    private void connectCamera() {
        ...
        try {
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                if(ContextCompat.checkSelfPermission((Activity)mContext, android.Manifest.permission.CAMERA) ==
