...
public class MainActivity extends AppCompatActivity {
  ...
  public void getAllEntry(View view) {
    ...
    final Cursor cursor =
        db.query(
            StudentDatabaseContract.StudentEntry.TABLE_NAME, col, null, null, null, null, null);
    print(cursor);
    cursor.close();
  }
  ...
  private void print(Cursor cursor) {
    while (cursor.moveToNext()) {
      String id = cursor.getString(cursor.getColumnIndex(StudentDatabaseContract.StudentEntry._ID));
      String name =
          cursor.getString(cursor.getColumnIndex(StudentDatabaseContract.StudentEntry.NAME));
      int age = cursor.getInt(cursor.getColumnIndex(StudentDatabaseContract.StudentEntry.AGE));
  ...
  public void filterQuery(View view) {
    ...
    final Cursor cursor =
        db.query(
            StudentDatabaseContract.StudentEntry.TABLE_NAME,
            col,
            selection,
            selectionArgs,
            null,
  ...
  public void insertData(View view) {
    ...
    long newRowId =
        mStudentDatabaseOpenHelper
            .getWritableDatabase()
            .insert(StudentDatabaseContract.StudentEntry.TABLE_NAME, null, values);
    ...
    newRowId =
        mStudentDatabaseOpenHelper
            .getWritableDatabase()
            .insertOrThrow(StudentDatabaseContract.StudentEntry.TABLE_NAME, null, values);
    Log.d("DIPANKAR", "Insert Done:" + newRowId);
  }
  ...
  public void updateData(View view) {
    ...
    int deletedRows =
        mStudentDatabaseOpenHelper
            .getWritableDatabase()
            .update(
                StudentDatabaseContract.StudentEntry.TABLE_NAME, values, selection, selectionArgs);
  ...
  public void getCount(View view) {
    ...
    Cursor c =
        mStudentDatabaseOpenHelper
            .getReadableDatabase()
            .query(tableName, null, selection, selectionArgs, null, null, null);
